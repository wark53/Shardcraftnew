 ...
 *
 */
package net.mcreator.shardcraft;
...
@Mod("shardcraft")
public class ShardcraftMod {
	public static final Logger LOGGER = LogManager.getLogger(ShardcraftMod.class);
	public static final String MODID = "shardcraft";
